...
import com.example.together.adapter.ChatAdapter;
import com.example.together.models.MessageItem;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(FirebaseHelper.nickName);
    ...
    public void clickSend(View view) {
        ...
        String nickName= FirebaseHelper.nickName;
        String message= et.getText().toString();
        String pofileUrl= FirebaseHelper.profileUrl;
