...
public class test extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //폰에 저장되어 있는 프로필 읽어오기
        loadData();
        if(FirebaseHelper.nickName!=null){
            etName.setText(FirebaseHelper.nickName);
            Picasso.get().load(FirebaseHelper.profileUrl).into(ivProfile);
    ...
    void saveData(){
        ...
        FirebaseHelper.nickName= etName.getText().toString();
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                imgRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        FirebaseHelper.profileUrl= uri.toString();
                        Toast.makeText(test.this, "프로필 저장 완료", Toast.LENGTH_SHORT).show();
                        ...
                        profileRef.child(FirebaseHelper.nickName).setValue(FirebaseHelper.profileUrl);

                        //2. 내 phone에 nickName, profileUrl을 저장
                        SharedPreferences preferences= getSharedPreferences("account",MODE_PRIVATE);
                        SharedPreferences.Editor editor=preferences.edit();

                        editor.putString("nickName",FirebaseHelper.nickName);
                        editor.putString("profileUrl", FirebaseHelper.profileUrl);
    ...
    void loadData(){
        SharedPreferences preferences=getSharedPreferences("account",MODE_PRIVATE);
        FirebaseHelper.nickName=preferences.getString("nickName", null);
        FirebaseHelper.profileUrl=preferences.getString("profileUrl", null);
